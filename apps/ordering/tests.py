...
class UpdateIngredientStockOnCookingTest(TestCase):
    ...
    def setUp(self):
        ...
        self.ingredients = [
            ...
            Ingredient.objects.create(name="Espresso", measurement_unit="g"),
        ]
        self.available_ingredients = [
            AvailableAtTheBranch.objects.create(
                branch=self.branch, ingredient=self.ingredients[0], quantity=1000
            ),
            AvailableAtTheBranch.objects.create(
                branch=self.branch, ingredient=self.ingredients[1], quantity=1000
            ),
            AvailableAtTheBranch.objects.create(
                branch=self.branch, ingredient=self.ingredients[2], quantity=1000
            ),
        ]
        ...
        self.compositions = [
            Composition.objects.create(
                item=self.item, ingredient=self.ingredients[0], quantity=200
            ),
            Composition.objects.create(
                item=self.item, ingredient=self.ingredients[1], quantity=50
            ),
            Composition.objects.create(
                item=self.item, ingredient=self.ingredients[2], quantity=100
            ),
        ]
    ...
    def test_update_ingredient_stock_on_cooking(self):
        ...
        self.assertEqual(
            AvailableAtTheBranch.objects.get(
                id=self.available_ingredients[0].id
            ).quantity,
            800,
        )
        self.assertEqual(
            AvailableAtTheBranch.objects.get(
                id=self.available_ingredients[1].id
            ).quantity,
            950,
        )
        self.assertEqual(
            AvailableAtTheBranch.objects.get(
                id=self.available_ingredients[2].id
            ).quantity,
            900,
        )
...
class CreateOrderViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.available_ingredients = [
            AvailableAtTheBranch.objects.create(
                branch=cls.branch1, ingredient=cls.ingredients[0], quantity=1000
            ),
            AvailableAtTheBranch.objects.create(
                branch=cls.branch1, ingredient=cls.ingredients[1], quantity=1000
            ),
            AvailableAtTheBranch.objects.create(
                branch=cls.branch1, ingredient=cls.ingredients[2], quantity=1000
            ),
            AvailableAtTheBranch.objects.create(
                branch=cls.branch2, ingredient=cls.ingredients[0], quantity=200
            ),
            AvailableAtTheBranch.objects.create(
                branch=cls.branch2, ingredient=cls.ingredients[1], quantity=200
            ),
            AvailableAtTheBranch.objects.create(
                branch=cls.branch2, ingredient=cls.ingredients[2], quantity=200
            ),
        ]
        ...
        cls.compositions = [
            Composition.objects.create(
                item=cls.item1, ingredient=cls.ingredients[0], quantity=200
            ),
            Composition.objects.create(
                item=cls.item1, ingredient=cls.ingredients[1], quantity=50
            ),
            Composition.objects.create(
                item=cls.item1, ingredient=cls.ingredients[2], quantity=100
            ),
            Composition.objects.create(
                item=cls.item2, ingredient=cls.ingredients[0], quantity=100
            ),
            Composition.objects.create(
                item=cls.item2, ingredient=cls.ingredients[1], quantity=25
            ),
            Composition.objects.create(
                item=cls.item2, ingredient=cls.ingredients[2], quantity=50
            ),
        ]
    ...
    def test_create_order(self):
        ...
        self.assertEqual(
            ReadyMadeProductAvailableAtTheBranch.objects.get(id=2).quantity, 998
        )
