        ...
        request_body=openapi.Schema(
            ...
            properties={
                "total_price": openapi.Schema(
                    type=openapi.TYPE_NUMBER, description="Total price of the order"
                ),
                "spent_bonus_points": openapi.Schema(
                    type=openapi.TYPE_INTEGER,
                    description="Bonus points spent on the order",
                ),
                "in_an_institution": openapi.Schema(
                    type=openapi.TYPE_BOOLEAN,
                    description="Whether the order is made in an institution",
                ),
                "table_number": openapi.Schema(
                    type=openapi.TYPE_INTEGER, description="Table number of the order"
                ),
                    ...
                    items=openapi.Schema(
                        ...
                        properties={
                            "item_id": openapi.Schema(
                                type=openapi.TYPE_INTEGER, description="ID of the item"
                            ),
                            "is_ready_made_product": openapi.Schema(
                                type=openapi.TYPE_BOOLEAN,
...
class AddItemToOrderView(APIView):
    ...
    def post(self, request):
        ...
        is_ready_made_product = (
            True if request.query_params["is_ready_made_product"] == "true" else False
        )
