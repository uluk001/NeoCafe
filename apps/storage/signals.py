...
from apps.storage.models import (
    ...
    AvailableAtTheBranch, ReadyMadeProduct,
...
models_to_listen = [Item, Ingredient, Composition, AvailableAtTheBranch, ReadyMadeProduct, ReadyMadeProductAvailableAtTheBranch, MinimalLimitReached]
